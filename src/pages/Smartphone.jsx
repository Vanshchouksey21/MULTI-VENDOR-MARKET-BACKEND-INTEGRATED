...
const Smartphone = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const smartphoneProducts = res.data.filter((product) =>
  ...
  return (
    <>
      ...
      <section
        className="hero-section text-white text-center d-flex align-items-center justify-content-center flex-column banner-animation"
        style={{
      ...
      {/* Product Grid for Smartphones */}
      <section style={styles.container}>
        <h2 style={styles.heading}>📱 Explore Our Smartphones</h2>
        <Row className="g-4">
